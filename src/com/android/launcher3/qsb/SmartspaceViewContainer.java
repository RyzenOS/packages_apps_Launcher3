...
import com.android.launcher3.RyzenLauncher;
import com.android.launcher3.RyzenLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        RyzenLauncher launcher = (RyzenLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        RyzenLauncherModelDelegate delegate = (RyzenLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        RyzenLauncher launcher = (RyzenLauncher) ActivityContext.lookupContext(getContext());

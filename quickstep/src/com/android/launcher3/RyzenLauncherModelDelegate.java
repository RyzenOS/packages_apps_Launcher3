...
public class RyzenLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "RyzenLauncherModelDelegate";
    ...
    public RyzenLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
